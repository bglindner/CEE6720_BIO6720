...
4. Based on these visualizations: report the number of genes shared between the two genomes above 90% and 99.5% identity. Report the one-way and two-way ANIs between this genome pair.
